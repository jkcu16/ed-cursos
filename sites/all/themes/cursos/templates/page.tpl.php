...
<?php if (!empty($page['header_1']) || !empty($page['header_2'])): ?>
    <header class="main-header">
        <div class="ed-container">
            <div class="ed-item main-header__block main-header__1 base-50 web-20">
                <?php print render($page['header_1']); ?>
            </div>
            <div class="ed-item main-header__block main-header__2 base-50 web-80">
...
<?php if (!empty($page['pre-content'])): ?>
    <div class="ed-container">
        <div class="ed-item" id="pre-content">
...
<!-- Pre Content: Region a todo lo ancho del viewport -->
    ...
    <div id="main">
	  	<div class="grupo">
  			...
  			<?php endif; ?>
  			<?php if (!empty($page['sidebar_first']) && empty($page['sidebar_second']) ): ?>
  				<div id="content" class="contenido caja web-75 sidebar-first">
  			<?php endif; ?>
  			<?php if (empty($page['sidebar_first']) && !empty($page['sidebar_second']) ): ?>
  				<div id="content" class="contenido caja web-75 sidebar-second">
  			<?php endif; ?>
			    <a id="main-content"></a>
		    ...
		    <?php if (!empty($page['sidebar_first'])): ?>
	  		    <aside id="sidebar_first" class="sidebar caja web-25">
					<?php print render($page['sidebar_first']); ?>
	  		    </aside>
	  		<?php endif; ?>

	  		<?php if (!empty($page['sidebar_second'])): ?>
	  		    <aside id="sidebar_second" class="sidebar caja web-25">
